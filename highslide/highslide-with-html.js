...
lang : {
	...
	fullExpandTitle : 'В натуральный размер',
	creditsText : '<i>Я-Сам</i>',
	creditsTitle : ' Я-Сам',
	...
	closeText : 'Закрыть', 
	closeTitle : 'Закрыть', 
	resizeTitle : 'К исходному размеру',
	playText : 'Слайдшоу',
	playTitle : 'Слайдшоу',
	pauseText : 'Пауза',
	pauseTitle : 'Остановить слайдшоу',
	previousTitle : 'Предыдущая(влево)',
	nextTitle : 'Следующая (вправо)',
	moveTitle : 'Передвинуть',
	fullExpandText : '1:1',
	number: 'Картинка %1 из %2',
	restoreTitle : 'Кликните чтобы закрыть, кликните и потяните чтобы передвинуть.'
},
// See http://xn----8sb0bs2e.net/ref for examples of settings  
...
creditsHref : 'http://www.xn----8sb0bs2e.net/',
